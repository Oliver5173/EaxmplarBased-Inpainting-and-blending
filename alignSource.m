...
%figure(1), hold off, imagesc(im_s2), axis image, title('im_s2');
figure(2), hold off, imagesc(im_t), axis image, title('Direct Copy');
%figure(3), hold off, imagesc(mask2), axis image, title('mask2');
drawnow;
